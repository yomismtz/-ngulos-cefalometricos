...
OutputDir=..\installer
OutputBaseFilename=YomCeph_Desktop_Setup_v0.11
Compression=lzma2
...
[UninstallDelete]
; La base de investigación NO se elimina al desinstalar. Se guarda fuera de {app},
; en %LOCALAPPDATA%\YomCeph\ResearchData, para conservar los 103 casos.
